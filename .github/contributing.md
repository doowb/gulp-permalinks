# Contributing to gulp-permalinks

First and foremost, thank you! We appreciate that you want to contribute to gulp-permalinks, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for gulp-permalinks**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for gulp-permalinks:

- star the [project](https://github.com/doowb/gulp-permalinks)
- tweet your support for gulp-permalinks
...
- **version**: please note the version of gulp-permalinks are you using
...
[so]: http://stackoverflow.com/questions/tagged/gulp-permalinks